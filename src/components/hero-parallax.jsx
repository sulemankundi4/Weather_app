    ...
    <div ref={ref} className="h-[300vh] py-40 overflow-hidden  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]">
      <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
        <h1 className="text-2xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 text-center">
          Stay Ahead of the <br /> Weather
        </h1>
        <p className="max-w-2xl text-base md:text-xl text-center mx-auto mt-8 text-neutral-400">Get instant weather updates and forecasts for any location worldwide. Accurate, timely, and easy to understand.</p>
      </div>
      <motion.div
        style={{
          rotateX,
